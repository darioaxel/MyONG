...
def seed_socios_y_pagos(apps, schema_editor):
    ...
    if not settings.DEBUG:
        print("⚠️ Seed omitido: DEBUG=False")
        return
    ...
    if Socio.objects.filter(email='ana@example.com').exists():
        print("⚠️ Seed ya ejecutado, saltando")
        return
    ...
    dir1 = Direccion.objects.create(
        ...
        provincia='Zaragoza', codigo_postal=50001, pais='España'
    )
    socio1 = Socio.objects.create(
        id=uuid.uuid4(), nombre='Ana', apellidos='García',
    ...
    dir2 = Direccion.objects.create(
        ...
        provincia='Zaragoza', codigo_postal=50002, pais='España'
    )
    ...
    print("✅ Creados 2 socios con pagos")
...
def reverse(apps, schema_editor):
    ...
    print("🗑️  Datos de seed eliminados")
